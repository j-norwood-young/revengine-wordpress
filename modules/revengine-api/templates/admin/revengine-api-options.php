                ...
                <tr>
                    ...
                    <td>
                        <label for="revengine_api_types">
                            <input style="width: 600px; height: 40px;" name="revengine_api_types" placeholder="article, cartoon, opinion" id="revengine_api_types" type="text" value="<?php esc_attr_e(get_option('revengine_api_types') ); ?>">
